...
export default function Modal({ children, onClose, title, size }) {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center">
      ...
      <div className={`relative z-10 bg-white rounded-sm max-h-[90vh] overflow-y-auto pb-4 flex flex-col gap-2 ${sizeClassMap[size] || sizeClassMap.md} `} role="dialog" aria-modal="true">
